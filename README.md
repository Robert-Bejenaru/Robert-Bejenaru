...
| Project | Tools | Focus |
|---|---|---|
| [Retail Sales Performance Analysis](./project-readmes/powerbi-retail-sales/README.md) | Power BI, DAX, Power Query | Revenue, profit, regional performance and discount impact |
| [Bookstore Performance & Publisher Insights](./project-readmes/tableau-bookstore-performance/README.md) | Tableau | Q1 sales, genres, regions, publishers and trends |
| [Insurance Charges Analysis](./project-readmes/python-insurance-analysis/README.md) | Python, Matplotlib, Seaborn | Drivers of insurance charges |
| [Exploring Global Happiness with SQL](./project-readmes/sql-happiness-index/README.md) | SQL | Happiness, GDP, social support, health and corruption |
